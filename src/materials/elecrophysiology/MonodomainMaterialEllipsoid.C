#include "MonodomainMaterialEllipsoid.h"
//#include "TensorHelpers.h"

registerMooseObject("MECHApp", MonodomainMaterialEllipsoid);

template <>
InputParameters
validParams<MonodomainMaterialEllipsoid>()
{
...
MonodomainMaterialEllipsoid::MonodomainMaterialEllipsoid(
...
void
MonodomainMaterialEllipsoid::computeQpProperties()
{
