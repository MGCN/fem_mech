...
#include "ConservativeAdvectionSUPG.h"
#include "Function.h"

registerMooseObject("MECHApp", ConservativeAdvectionSUPG);

template <>
InputParameters
validParams<ConservativeAdvectionSUPG>()
{
...
ConservativeAdvectionSUPG::ConservativeAdvectionSUPG(const InputParameters & parameters)
: Kernel(parameters),
...
Real
ConservativeAdvectionSUPG::negSpeedQp() const
{
...
Real
ConservativeAdvectionSUPG::computeQpResidual()
{
...
Real
ConservativeAdvectionSUPG::computeQpJacobian()
{
