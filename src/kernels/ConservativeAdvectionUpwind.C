...
#include "ConservativeAdvectionUpwind.h"

registerMooseObject("MECHApp", ConservativeAdvectionUpwind);

template <>
InputParameters
validParams<ConservativeAdvectionUpwind>()
{
...
ConservativeAdvectionUpwind::ConservativeAdvectionUpwind(const InputParameters & parameters)
: Kernel(parameters),
...
Real
ConservativeAdvectionUpwind::negSpeedQp() const
{
    return -_grad_test[_i][_qp] * _velocity;
}

Real
ConservativeAdvectionUpwind::computeQpResidual()
{
...
Real
ConservativeAdvectionUpwind::computeQpJacobian()
{
    // This is the no-upwinded version
...
void
ConservativeAdvectionUpwind::computeResidual()
{
    switch (_upwinding)
    {
        ...
        case UpwindingType::full:
            ...
            break;
        case UpwindingType::quick:
            quickUpwind(JacRes::CALCULATE_RESIDUAL);
            break;
    }
}

void
ConservativeAdvectionUpwind::computeJacobian()
{
    switch (_upwinding)
    {
        case UpwindingType::none:
        ...
        case UpwindingType::full:
            ...
            break;
        case UpwindingType::quick:
            quickUpwind(JacRes::CALCULATE_JACOBIAN);
            break;
    }
}

void
ConservativeAdvectionUpwind::quickUpwind(JacRes res_or_jac)
{
...
void
ConservativeAdvectionUpwind::fullUpwind(JacRes res_or_jac)
{
    // The number of nodes in the element
    const unsigned int num_nodes = _test.size();
