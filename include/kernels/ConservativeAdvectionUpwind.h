...
#ifndef CONSERVATIVEADVECTIONUPWIND_H
#define CONSERVATIVEADVECTIONUPWIND_H

#include "Kernel.h"

// Forward Declaration
class ConservativeAdvectionUpwind;
 ...
 */
template <>
InputParameters validParams<ConservativeAdvectionUpwind>();

class ConservativeAdvectionUpwind : public Kernel
{
public:
    ConservativeAdvectionUpwind(const InputParameters & parameters);
...
protected:
    ...
    /// Type of upwinding
    const enum class UpwindingType { none, full, quick } _upwinding;
    ...
    void quickUpwind(JacRes res_or_jac);
