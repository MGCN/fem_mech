#ifndef QQ_2D_NH_STRAIN_H
#define QQ_2D_NH_STRAIN_H

#include "Kernel.h"

class QQ_2D_NH_strain;

template<>
InputParameters validParams<QQ_2D_NH_strain>();


class QQ_2D_NH_strain : public Kernel
{
public:
    QQ_2D_NH_strain( InputParameters const & params);
protected:
