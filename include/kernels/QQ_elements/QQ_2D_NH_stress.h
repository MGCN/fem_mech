#ifndef QQ_2D_NH_STRESS_H
#define QQ_2D_NH_STRESS_H

#include "Kernel.h"

class QQ_2D_NH_stress;

template<>
InputParameters validParams<QQ_2D_NH_stress>();


class QQ_2D_NH_stress : public Kernel
{
public:
    QQ_2D_NH_stress( InputParameters const & params);
protected:
    ...
    void computeJacobian2D(unsigned int jvar);
...
//    VariableValue    const & _disp_z;
    ...
    RealTensorValue * _H;
    RealTensorValue * _HV;
    RealTensorValue * _E_lin_H;
    RealTensorValue * _Slin;
    
    RealTensorValue * _HV_QQ;
    RealTensorValue * _Slin_QQ;
