...
#ifndef HHTStressDivergenceFast_H
#define HHTStressDivergenceFast_H

#include "Kernel.h"
#include "ElasticMaterial.h"

class HHTStressDivergenceFast;

template <>
InputParameters validParams<HHTStressDivergenceFast>();

class HHTStressDivergenceFast : public Kernel
{
public:
    HHTStressDivergenceFast(
